...
public class AlarmActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                dialog.setPositiveButton("Ok", new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        DatabaseSQLite.init(AlarmActivity.this);
        ...
        mathAlarmListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View v, int position, long id) {
                ...
                Intent intent = new Intent(AlarmActivity.this, AlarmPreActivity.class);
    ...
    public void updateAlarmList(){
        DatabaseSQLite.init(AlarmActivity.this);
        final List<Alarm> alarms = DatabaseSQLite.getAll();
