package com.example.chart001.lbreminder.DatabaseSQLite;
...
//import com.example.chart001.lbreminder.Alarm.Difficulty;
...
public class DatabaseSQLite extends SQLiteOpenHelper {
    static DatabaseSQLite instance = null;
    static SQLiteDatabase database = null;

    static final String DATABASE_NAME = "chart";
    ...
    public static List<Alarm> getAll() {
        ...
        Cursor cursor = DatabaseSQLite.getCursor();
